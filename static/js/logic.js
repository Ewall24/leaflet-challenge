...
function chooseColor(depth) {
    switch(true) {
        case (depth <= 10):
            return "#00A3E0"; // Very shallow depths in light blue
        case (depth <= 30):
            return "#00B2A9"; // Shallow to medium depths in teal
        case (depth <= 50):
            return "#7FCE7F"; // Medium depths in light green
        case (depth <= 70):
            return "#F4B431"; // Deeper depths in amber
        case (depth <= 90):
            return "#F16A6A"; // Very deep depths in coral
        default:
            return "#B03A2E"; // Default color in dark red
    }
}
